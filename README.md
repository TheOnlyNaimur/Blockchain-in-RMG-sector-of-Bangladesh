...
### For Anvil testing the addresses are

| Role | Address (public) | Anvil Account |
|---|---|---|
| Deployer | `0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266` | #0 |
| Seller | `0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC` | #2 |
| Buyer | `0x70997970C51812dc3A010C7d01b50e0d17dc79C8` | #1 |
| Certifier | `0x90F79bf6EB2c4f870365E785982E1f101E93b906` | #3 |
| Quality Checker | `0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65` | #4 |
| Freight Forwarder | `0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc` | #5 |
| Export Customs | `0x976EA74026E726554dB657fA54763abd0C3a0aa9` | #6 |
| Import Customs | `0x14dC79964da2C08b23698B3D3cc7Ca32193d9955` | #7 |
| Compliance Checker | `0x23618e81E3f5cdF7f54C3d65f7FBc0aBf5B21E8f` | #8 |

Private keys: get them from the `anvil` console output (do not commit).
